...
1. Make an [Issue](https://github.com/crawfissoftware/CrawfisSoftware.UnityTiling/issues/new)
...
```json
    {
        "dependencies": {
            "com.crawfissoftware.CrawfisSoftware.UnityTiling": "https://github.com/YOUR_USER/CrawfisSoftware.UnityTiling.git"
        }
    }
```
...
reported to the community leaders responsible for enforcement at roger.crawfis@gmail.com.
